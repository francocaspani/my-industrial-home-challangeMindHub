...
const basketControllers = {
    ...
    getProduct: async (req, res) => {
        ...
        try {
            ...
            console.log(basket)
            console.log('TOTALLLLLLLLLLL')
            console.log(total)
            sendOrderConfirmation(basket, total)
            // sendOrden(basket y total)
    ...
    modifyStock: async (req, res) => {
        ...
        try {
            ...
            const productNewStock = await Product.findOneAndUpdate({ "_id": modifyStock[0].productId._id }, {
                $set: {
                    "stock": stock
                }
            }, { new: true })
